...
const Home = () => {
  ...
  return (
    <>
      ...
      <div
  className="parallax1 flex flex-col items-center justify-start mx-auto h-[70vh] w-[85%] bg-contain bg-center bg-fixed bg-no-repeat mb-4"
  style={{ backgroundImage: "url('/assets/images/ptl_old.jpg')" }}
>
